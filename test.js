...
// dbInstance.ref("/database/users").orderByChild("password").equalTo("anita@payohima.comSvzziBzDGCgWQKLFcxd1iF/4DK8=").once("value", (snapshot)=>{
//     if (snapshot.val()){
//         for(var d in snapshot.val()){
//             console.log(d, snapshot.val()[d]);
//             break;
//         }
//     }
// });
